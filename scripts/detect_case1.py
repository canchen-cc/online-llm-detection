...
from methods_composite_null_case1 import betting_experiment
...
def load_data(file_path, data_type):
    try:
        with open(file_path, 'r') as f:
            data = json.load(f)
        return data['predictions'][data_type]  #data_type='real'/'samples', where 'real': scores of human texts; 'samples': scores of LLM texts
    except KeyError:
